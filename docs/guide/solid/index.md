---
title: Solid 版 YCloud Icons
description: YCloud Icons 提供 Solid 图标组件库，方便你将图标集成到 Solid 应用中。每个图标都是独立 Solid 组件，便于集成和自定义。
nextPage:
  - getting-started
---
...
# Solid 版 YCloud Icons

在 Solid 应用中使用 YCloud Icons 时，每个图标都是一个独立 Solid 组件，方便按需引入、渲染和定制。

功能列表：

- **易于使用**：按需导入图标组件，并直接在 Solid 组件中使用。
