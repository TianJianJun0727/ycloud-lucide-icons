...
description: 了解 `@ycloud-web/icons-react` 包导出的类型，以及如何在 React 应用中使用它们。
---

# TypeScript 支持

下面是 `@ycloud-web/icons-react` 包导出的类型。
...
```tsx
import { type YCloudIconsProps } from '@ycloud-web/icons-react';
