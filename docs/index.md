...
hero:
  ...
  tagline: Typed React components, Vue and multi-framework packages, static assets, and tree-shakable icon data from one shared source.
  image:
    src: /favicon.svg
    alt: YCloud Icons
  actions:
...
features:
  ...
  - title: Multi-framework packages
    details: React, Vue, Svelte, Solid, Preact, React Native, Angular, Astro, and static assets are documented from the same icon source.
    icon: |
  ...
  - title: Private or public publishing
    details: The repository is ready for npm Trusted Publishing and can later be adapted for an internal registry.
    icon: |
