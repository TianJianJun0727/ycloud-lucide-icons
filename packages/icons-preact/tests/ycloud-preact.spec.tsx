...
import { Pen, Edit2, Grid, Droplet } from '../src/ycloud-preact';
...
describe('Using ycloud icon components', () => {
  ...
  it('should apply all classes to the element', () => {
    ...
    expect(container.firstChild).toHaveClass('ycloud');
    expect(container.firstChild).toHaveClass('ycloud-droplet');
  });
});
